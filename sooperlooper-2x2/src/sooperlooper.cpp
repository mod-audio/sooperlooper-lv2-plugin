...
passthrough:
        ...
        for (;lSampleIndex < SampleCount;
                lSampleIndex++)
        {
            plugin->temp_buffer[s_index] = fDry * pfInput[lSampleIndex];
            plugin->temp_buffer[s_index + 1] = fDry * pfInput_1[lSampleIndex];
